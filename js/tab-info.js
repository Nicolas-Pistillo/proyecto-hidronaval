...
const dataUl = [
    ...
    },
    {
        ...
        data: `
        <li>Recibiras un <strong>certificado</strong> avalado por prestigiosos entes del area naval como ser SICONARA, 
SAONSINRA, SAON (Sindicato de conductores navales y obreros navales)</li>
